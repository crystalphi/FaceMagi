...
class MobileUNet(nn.Module):
    def __init__(self, class_num = 1, pre_train = 'mobilenet_v2.pth.tar'):
        ...
        if pre_train is not None:
            print("load pre_train .........")
            pre_train_path = os.path.join(app_config.MODEL_DIR, 'face_parsing', pre_train)
            self.base_model.load_state_dict(torch.load(pre_train_path))
