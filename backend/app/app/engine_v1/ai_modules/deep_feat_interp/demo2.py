...
if __name__=='__main__':
  ...
  parser.add_argument('method',type=str,choices=['older','younger','facehair','senior'],help='desired transformation')
  ...
  for i in range(len(X)):
    xX=X[i]
    print("processing test image:", xX)
    ...
    elif config.method == 'senior':
      cP=[(gender,XA[gender]>=0),(fields.index('senior'),False)]
      cQ=[(gender,XA[gender]>=0),(fields.index('senior'),True)]
    else:
    ...
    print("fit the best 4K database images to input image")
    ...
    print("use the K best fitted images")
