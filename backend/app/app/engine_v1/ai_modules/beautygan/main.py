...
parser.add_argument('--no_makeup', type=str, default=os.path.join('imgs', 'no_makeup', '202600.jpg'), help='path to the no_makeup image')
...
#img_input = imread(args.no_makeup) # 如果读取的图片数据为 RGBA 格式，下面处理时会报错
#所以改为
img_input = cv2.imread(args.no_makeup)
